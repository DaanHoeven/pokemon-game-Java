...
public abstract class PokemonApplication {
    public static void main(String[] args) {
        ...
        Eevee Eevee1 = new Eevee("Daan", "eevee", "normal", 200, 60.12, 1220, 2000);
        Squirtle Squirtle1 = new Squirtle("Bert", "squirtle", "water", 26, 51.87, 122, 2000);
        Squirtle Squirtle2 = new Squirtle("Bertrand", "squirtle", "water", 38, 57.87, 1129, 2080);
        Wartortle Wartortle1 = new Wartortle("Gevechtschilpad", "wartortle", "water", 120, 120, 800, 3000);
        Zubat Zubat1 = new Zubat("Zuiger", "zubart", "poison / flying", 100, 30, 200, 1000);
