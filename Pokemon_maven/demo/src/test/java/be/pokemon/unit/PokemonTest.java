...
public class PokemonTest {
    ...
    void givenValidName_whenSetName_thenNameIsSet() {
        Eevee pokemon = new Eevee("Denis", "squirtle", "normal", 5, 0.4, 50.0, 100);
        assertEquals("Denis", pokemon.getName());
    }

    @Test
    void givenNullName_whenSetName_thenThrowsDomainException() {
        assertThrows(DomainException.class, () -> new Eevee(null, "squirtle", "normal", 5, 0.4, 50.0, 100));
    }

    @Test
    void givenEmptyName_whenSetName_thenThrowsDomainException() {
        assertThrows(DomainException.class, () -> new Eevee("", "squirtle", "normal", 5, 0.4, 50.0, 100));
    }

    @Test
    void givenPositiveLevel_whenSetLevel_thenLevelIsSet() {
        Eevee pokemon = new Eevee("Charmander", "squirtle", "eevee", 5, 0.6, 60.0, 100);
        assertEquals(8, pokemon.levelUpByNumber(3));
    }

    @Test
    void givenNegativeLevel_whenSetLevel_thenThrowsDomainException() {
        assertThrows(DomainException.class, () -> new Eevee("Bulbasaur", "squirtle", "normal", -3, 0.5, 40.0, 50));
    }

    @Test
    void givenPositiveHeight_whenSetHeight_thenHeightIsSet() {
        Eevee pokemon = new Eevee("Squirtle", "squirtle", "normal", 3, 0.5, 40.0, 50);
        assertEquals(0.5, pokemon.getHeight());
    }

    @Test
    void givenNegativeHeight_whenSetHeight_thenThrowsDomainException() {
        assertThrows(DomainException.class, () -> new Eevee("Squirtle", "squirtle", "normal", 3, -0.5, 40.0, 50));
    }

    @Test
    void givenPositiveHp_whenSetHp_thenHpisSet() {
        Eevee pokemon = new Eevee("Bulbasaur", "squirtle", "normal", 3, 0.5, 40.0, 50);
        pokemon.sethp(60.0);
    ...
    void givenPositiveLevels_whenLevelUpByNumber_thenLevelIsIncreased() {
        Eevee pokemon = new Eevee("Charmander", "squirtle", "normal", 5, 0.6, 60.0, 100);
        assertEquals(8, pokemon.levelUpByNumber(3));
    }
